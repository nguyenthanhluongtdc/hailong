server {
    server_name hailongglass.dev.gistensal.com www.hailongglass.dev.gistensal.com;
    root   /home/dev/htdocs/hailongglass/public;
    ...
    ## more_set_headers 'X-Frame-Options:ALLOW-FROM http://hailongglass.dev.gistensal.com';
    ...
    ## access_log /home/dev/logs/hailongglass.access.log;
    access_log off;
    error_log /home/dev/logs/hailongglass.error.log;	
    server_tokens off;
