                    ...
                    <div id="contact-form" class="form-horizontal form-contact-us">
                        ...
                        @endif
                                ...
                                <div class="form-group">
                                    <input type="text" class="form-control" id="contact_name" placeholder="Họ tên" name="name" value="{{ __('Full name') }}">   
                                </div>
                                <div class="form-group">
                                    <input type="text" class="form-control" id="contact_phone" placeholder="Số điện thoại" name="phone" value="{{ __('Phone number') }}">
                                </div>
                                
                                <div class="form-group">
                                    <input type="email" class="form-control" id="contact_email" placeholder="Email" name="email" value="{{ __('Email') }}">
                                </div>
                                <div class="form-group">
                                    <input type="text" class="form-control" id="contact_address" placeholder="Địa chỉ" name="address" value="{{ __('Address') }}">
                                </div>
                                 
                                <div class="form-group">
                                    <input type="text" class="form-control" name="subject" value="{{ __('Subject') }}" id="contact_subject"
                                        placeholder="{{ __('Subject') }}">
                                </div>
                                 
                                <div class="form-group">
                                    <textarea name="content" id="contact_content" class="form-control" rows="5" placeholder="{{ __('Content') }}">{{ __('Content') }}</textarea>
                                </div>
                        ...
                        <div class="policy custom-checkbox">
                            <label class="customcheck">
                                <input type="checkbox" checked="checked"><a title="Chúng tôi cam kết bảo mật thông tin cá nhân" href="" class="policy__link">
                                    {{__('Commit')}}
                                </a>
