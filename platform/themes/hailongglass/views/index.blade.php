...
<div id="home-page">
                ...
                <div class="row">
                    <div class="col-4 pr-0"> 
                        <div class="section-ourproduct__left">
                            <img src="{{Theme::asset()->url('images/home/section_ourproduct__picture.png')}}" alt="" />
                        </div>
                    </div>
    ...
    <div class="section-whychoose-wrapper">
        <div class="container">
            <div class="section-whychoose hailongglass-header-section">
                <div class="row">
                    <div class="col-md-6">
                        <div class="hailongglass-header-section__header">
                        ...
                        <ul class="section-whychoose__list">
                    ...
                    <div class="col-md-6">
                        <div class="section-whychoose__picture">
                            <img src="{{Theme::asset()->url('images/home/19_projects_-_header_image.png')}}" alt="" />
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="section-showroom-wrapper">
        <div class="container">
            <div class="section-showroom hailongglass-header-section">
                <div class="hailongglass-header-section__header">
                    <h2 class="hailongglass-header-section__header__title">
                            ...
                            <div class="box__tabs">
                                <ul class="nav nav-tabs" id="myTab" role="tablist">
                                    <li class="nav-item box__tabs__header" role="presentation">
                                        <button class="nav-link active px-0" id="home-tab" data-bs-toggle="tab" data-bs-target="#home" type="button" role="tab" aria-controls="home" aria-selected="true"> Miền Nam </button>
                                    </li>
                                    
                                    <li class="nav-item box__tabs__header" role="presentation">
                                        <button class="nav-link px-0" id="home-tab" data-bs-toggle="tab" data-bs-target="#home" type="button" role="tab" aria-controls="home" aria-selected="true"> Miền Trung </button>
                                    </li>

                                    <li class="nav-item box__tabs__header" role="presentation">
                                        <button class="nav-link px-0" id="home-tab" data-bs-toggle="tab" data-bs-target="#home" type="button" role="tab" aria-controls="home" aria-selected="true"> Miền Bắc </button>
                                    </li>
                                </ul>
    ...
    <div class="section-news-wrapper">
        <div class="container">
            <div class="section-news hailongglass-header-section">
                <div class="hailongglass-header-section__header">
                    <h2 class="hailongglass-header-section__header__title">
                       Tin tức
                    </h2>  
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="col-core col-big">
                                <img class="col-core__img" src="{{Theme::asset()->url('images/home/architecture-buildings-city-373965.png')}}" alt="" />
                            ...
                            <div class="box-news-main">
                                <div class="col-core col-flex-box">
                                    <div class="col-core__box__img">
                                        <img class="col-core__img" src="{{Theme::asset()->url('images/home/architecture-buildings-city-373965_2.png')}}" alt="" />
                                    </div>
                                ...
                                <div class="col-core col-flex-box">
                                    <div class="col-core__box__img">
                                        <img class="col-core__img" src="{{Theme::asset()->url('images/home/architecture-buildings-city-373965_3.png')}}" alt="" />
                                    </div>
