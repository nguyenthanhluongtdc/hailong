        ...
        <div class="container-customize">
            <div class="section-collapse">
                <div class="theme-customize-header-section__header distance-below">
                    <h2 class="theme-customize-header-section__header__title">
                        Chính sách đổi trả sản phẩm của Hailong Glass
                    </h2>
                    <p class="theme-customize-header-section__header__des mb-3">
                        Thương hiệu được khẳng định bởi uy tín, chất lượng, tính an toàn và đặc biệt thân thiện với môi trường.Thương hiệu được khẳng định bởi uy tín, chất lượng, tính an toàn và đặc biệt thân thiện với môi trường
                    </p>
                            ...
                            <div class="card-header" id="headingFive">
                                <h5 class="mb-0">
                                    <button class="btn btn-link collapsed" data-toggle="collapse" data-target="#collapseFive" aria-expanded="false" aria-controls="collapseFive">
                                        Hailong Glass nói KHÔNG với hàng giả
                                    </button>
                                </h5>
                            </div>
                            ...
                            <div class="card-header" id="headingSix">
                                <h5 class="mb-0">
                                    <button class="btn btn-link collapsed" data-toggle="collapse" data-target="#collapseSix" aria-expanded="false" aria-controls="collapseSix">
                                        Tôi có thể đổi trả sản phẩm do lỗi kỹ thuật?
                                    </button>
                                </h5>
                            </div>
