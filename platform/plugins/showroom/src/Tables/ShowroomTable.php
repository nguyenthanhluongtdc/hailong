...
namespace Platform\Showroom\Tables;
...
class ShowroomTable extends TableAbstract
{
    ...
    public function columns()
    {
        return [
            ...
            'address' => [
                'title' => trans('plugins/showroom::showroom.address'),
                'class' => 'text-left',
            ],
            'phones' => [
                'title' => trans('plugins/showroom::showroom.phones'),
                'class' => 'text-left',
            ],
            'region' => [
                'title' => trans('plugins/showroom::showroom.region'),
                'class' => 'text-left',
            ],
            'created_at' => [
