...
namespace Platform\Showroom\Http\Controllers;
...
use Exception;
use Platform\Showroom\Tables\ShowroomTable;
use Platform\Base\Events\CreatedContentEvent;
use Platform\Base\Events\DeletedContentEvent;
use Platform\Base\Events\UpdatedContentEvent;
use Platform\Base\Http\Responses\BaseHttpResponse;
use Platform\Showroom\Forms\ShowroomForm;
...
class ShowroomController extends BaseController
{
    ...
    {
        page_title()->setTitle(trans('plugins/showroom::showroom.name'));
    ...
    {
        page_title()->setTitle(trans('plugins/showroom::showroom.create'));
    ...
    public function edit($id, FormBuilder $formBuilder, Request $request)
    {
        ...
        page_title()->setTitle(trans('plugins/showroom::showroom.edit') . ' "' . $showroom->name . '"');
