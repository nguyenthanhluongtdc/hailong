...
<span class="stamp @if ($order->payment->status == \Platform\Payment\Enums\PaymentStatusEnum::COMPLETED) is-completed @else is-failed @endif">{{ $order->payment->status->label() }}</span>
