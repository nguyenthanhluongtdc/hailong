            ...
            <div class="col-12">
                @if (Cart::instance('compare')->count())
                    @php
                        ...
                        $products = app(\Platform\Ecommerce\Repositories\Interfaces\ProductInterface::class)->advancedGet([
                           'condition' => [
                    ...
                    <div class="table-responsive table__compare">
                        <table class="table text-center">
                            ...
                            @php
                                $attributeSets = app(\Platform\Ecommerce\Repositories\Interfaces\ProductAttributeSetInterface::class)->getAllWithSelected(Cart::instance('compare')->content()->pluck('id'));
                            @endphp
                            ...
                            @foreach($attributeSets as $attributeSet)
                                <tr>
                                    ...
                                    @foreach(Cart::instance('compare')->content() as $item)
                                        ...
                                        @if (!empty($product))
                                            @php
                                                $attributes = app(\Platform\Ecommerce\Repositories\Interfaces\ProductInterface::class)->getRelatedProductAttributes($product)->where('attribute_set_id', $attributeSet->id)->sortBy('order');
                                            @endphp
