...
use Platform\Ecommerce\Repositories\Caches\ProductLabelCacheDecorator;
...
use Platform\Ecommerce\Repositories\Eloquent\ProductLabelRepository;
...
class EcommerceServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        SlugHelper::setPrefix(Product::class, 'product');
